...
const Display = (props) => {
  return (
    <>
      {/* clock face */}
      <div className="flex gap-1 sm:gap-0 outline -outline-offset-1 outline-2 outline-stone-700 shadow-display justify-center items-end sm:text-3xl text-stone-50 bg-stone-950 md:text-4xl lg:text-5xl pt-14 pb-16 sm:pt-10 sm:pb-12 px-2 sm:mx-10 md:mx-24 lg:mx-40 xl:mx-52 rounded-[2rem] selection:bg-stone-700 selection:text-green-500 ">
