    ...
    <>
      <div className="pb-8 pt-4 text-center font-semibold rounded-md mx-20 md:mx-28 lg:mx-48 xl:mx-72 sm:opacity-50 sm:hover:opacity-100 sm:ease-in-out sm:duration-300">
        ...
        <div className="block sm:hidden mx-auto max-w-7xl pb-6 px-2 sm:px-6 lg:px-8 ">
          <div className="mt-4 flex flex-1 justify-center">
            <div className="w-full flex flex-col items-center justify-center">
              <Link
                className="bg-[#0077B5] text-stone-100 hover:shadow-md rounded-md px-3 py-2 my-4 text-sm font-medium min-w-24"
                to={"https://www.linkedin.com/in/david-schraedel/"}
                target="_blank">
                LinkedIn
              </Link>
              ...
              <Link
                className="bg-[#2b3137] text-[#fafbfc] hover:shadow-md rounded-md px-3 py-2 my-4 text-sm font-medium min-w-24"
                to={"https://github.com/davidschraedel"}
                target="_blank">
                Github
              </Link>
        ...
        <Link
          ...
          className="text-stone-100 text-sm sm:text-md  hover:text-stone-600">
